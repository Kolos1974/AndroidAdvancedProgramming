package hu.kolos.karlovitz.locationandmapdemo
...
import hu.kolos.karlovitz.locationandmapdemo.databinding.ActivityMapsBinding
import hu.kolos.karlovitz.locationandmapdemo.location.MainLocationManager
import java.util.*
...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback, MainLocationManager.OnNewLocationAvailable {
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        // Az összes egyedi beállítás levétele
        if (false) {
            initMap()
            initPlaceSelect()
    ...
    private fun initMapAndMarkerClick() {
        ...
        mMap.setOnMarkerClickListener (object : GoogleMap.OnMarkerClickListener {
            override fun onMarkerClick(marker: Marker): Boolean {
                Toast.makeText(this@MapsActivity, "${marker!!.position.latitude}, ${marker!!.position.longitude}", Toast.LENGTH_LONG).show()
                return false
            }
        })
        */
    ...
    private fun initMap() {
        // Egyedi térkép stípus json alapján!

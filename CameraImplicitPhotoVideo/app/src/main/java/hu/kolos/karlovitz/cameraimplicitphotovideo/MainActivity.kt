package hu.kolos.karlovitz.cameraimplicitphotovideo
...
import hu.kolos.karlovitz.cameraimplicitphotovideo.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!allPermissionsGranted()) {
            // Az Activity-nek van ez a függvénye.
    ...
    // Ez a függvény megnézi, hogy a tömbben szereplő kéréseknek van-e engedélyük.
